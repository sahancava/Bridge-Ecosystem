...
contract TestToken is BECO20, Ownable {
    ...
    constructor() BECO20("Test Token", "TEST", 18, 1000 ether, 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506) {
        _rTotal = ~uint256(0) - (~uint256(0) % 1000 ether);
        _rOwned[_msgSender()] += _rTotal;

        addToExcludeList(_msgSender());

        emit Transfer(address(0), _msgSender(), 1000 ether);
    }
